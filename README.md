...
[![dependency status](https://deps.rs/crate/hexx/0.13.0/status.svg)](https://deps.rs/crate/hexx)
 ...
 *doubled* and *offset* coordinates.
 ...
 - `hexx = { version = "0.13", features = ["serde"] }`
 ...
 - `hexx = { version = "0.13", features = ["packed"] }`
 ...
 - `hexx = { version = "0.13", features = ["bevy_reflect"] }`
